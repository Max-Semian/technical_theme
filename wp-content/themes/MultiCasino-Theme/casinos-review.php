            ...
            <?php while (mcf_have_rows('Osnovnoy_kontent_Casinos_review_single')): mcf_the_row(); ?>
                ...
                <?php elseif (mcf_get_row_layout() === 'add_slots_block_Ispolzovat_tolko_odin_na_stranitse'): ?>
                    <section class="block DOWlz7LHfQhP" id="one-slots-block-1">
                        <h2 class="ttOKnNStIgHIN"><?php mcf_the_field('Title_slots_block'); ?></h2>

                        <section class="slots-items"></section>

                        <section class="rEHnqyaLPAcb">
                            <a href="#" id="one-slots-block-1-read-more" class="UUoOFZTKQLWyzx">
                                <?php mcf_the_field('Nazvanie_knopki_podgruzki_slots'); ?>
                            </a>
                        </section>

                        <script>
                            var oneSlotsTagIds = <?php echo json_encode(get_taxonomy_field('Po_kakomu_tegu_vyvodit_sloty')); ?>;
                        </script>
                    </section>
                            ...
                            <?php if (mcf_have_rows('add__faq')): ?>
                                <?php while (mcf_have_rows('add__faq')): mcf_the_row(); ?>
                                    ...
                                    <section class="faq-item">
                                        <section class="faq-item-title"><?php mcf_the_field('question'); ?></section>
