        ...
        <?php if (mcf_have_rows('add_block_template_slot_review')): ?>
            <?php while (mcf_have_rows('add_block_template_slot_review')): mcf_the_row(); ?>
                <?php if (mcf_get_row_layout() === 'Game_slots_iframe_template_slot_review'): ?>
                    <section class="block TomHEyzPWM4H2AR" id="blockReviewHead">
                        ...
                        <?php 
                        $iframe = mcf_get_field('iframe');
                       
                        if ($iframe): ?>
                            <section class="bzaYhmVZu53bf" id="boxGames">
                                <?= $iframe ?>
                            </section>
                        <?php endif; ?>
                        ...
                        <section class="SuZhockAv7dz">
                            ...
                            <section class="buttons">
                                ...
                                <?php if (mcf_get_field('Pokazyvat_vtoruyu_knopku_?') == 1) : ?>
                                    <a class="button HKYDfj0abmr lSxZiErAjnsDTin" id="btnPlay"><?php mcf_the_field('Name_btn_2'); ?></a>
                                <?php endif; ?>
                            </section>
                        </section>
                    </section>
                ...
                <?php elseif (mcf_get_row_layout() === 'Multicasino_template_slot_review'): ?>
                    <section class="block HgNEXbcXKiOWGk0V" id="multicasino-block-1">
                        ...
                        <section class="rEHnqyaLPAcb">
                            <a href="#" id="multicasino-block-1-read-more" class="UUoOFZTKQLWyzx">
                                <?php mcf_the_field('Nazvanie_knopki_podgruzki22'); ?>
                            </a>
                        </section>
                        <script>
                            var multicasinoTagIds = <?php echo json_encode(get_taxonomy_field('Po_kakomu_tegu_pokazyvat_kazino_v_bloke')); ?>;
                        </script>
                    </section>
                ...
                <?php elseif (mcf_get_row_layout() === 'More_Slots_template_slot_review'): ?>
                    <section class="block DOWlz7LHfQhP" id="more-slots-block-1">
                        <h2 class="ttOKnNStIgHIN"><?php mcf_the_field('Title_template_slot_review_lvl_8'); ?></h2>
                        <section class="slots-items"></section>
                        <section class="rEHnqyaLPAcb">
                            <a href="#" id="more-slots-block-1-read-more" class="UUoOFZTKQLWyzx">
                                <?php mcf_the_field('Nazvanie_knopki_podgruzki_slot_review'); ?>
                            </a>
                        </section>
                        <script>
                            var moreSlotsTagIds = <?php echo json_encode(get_taxonomy_field('Po_kakomu_tegu_vyvodit_slot_review')); ?>;
                        </script>
                    </section>
                            ...
                            <?php if (mcf_have_rows('add_faq')): ?>
                                <?php while (mcf_have_rows('add_faq')): mcf_the_row(); ?>
                                    <section class="faq-item">
                                        <section class="faq-item-title"><?php mcf_the_field('question_template_slot_review_lvl_9'); ?></section>
