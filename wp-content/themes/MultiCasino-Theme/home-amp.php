...
<section class="WqpOVDTcdNifJuCq PeFOrJkT335J">
    ...
    // -----------------------
    ?>
                    <section class="block HgNEXbcXKiOWGk0V">
                        <h2 class="ttOKnNStIgHIN pGogQv3MnXHv">
                            <?php mcf_the_field('Title_template_main_lvl_2'); ?>
                        </h2>
                        ...
                        <section class="best-casinos-items">
                            ...
                            $args = [
                                ...
                                'tax_query'      => [[
                                    'taxonomy' => 'post_tag',
                                    'field'    => 'term_id',
                                    'terms'    => array_map('intval', (array)get_taxonomy_field('Po_kakomu_tegu_vyvodit_luchshie_kazino')),
                                ]],
                            ];
    ...
    // -----------------------
    ?>
                    <section class="block DOWlz7LHfQhP">
                        <h2 class="ttOKnNStIgHIN">
                            <?php mcf_the_field('Title_template_main_lvl_6'); ?>
                        </h2>
                        ...
                        <section class="slots-items">
                            ...
                            $args = [
                                ...
                                'tax_query'      => [[
                                    'taxonomy' => 'post_tag',
                                    'field'    => 'term_id',
                                    'terms'    => array_map('intval', (array)get_taxonomy_field('Po_kakomu_tegu_vyvodit_luchshie_sloty')),
                                ]],
                            ];
							...
							<?php if (mcf_have_rows('add_faq_template_main_lvl_9')): ?>
								<?php while (mcf_have_rows('add_faq_template_main_lvl_9')): mcf_the_row(); ?>
									<amp-accordion animate expand-single-section class="faq-item">
										<section>
											<h2 class="faq-item-title"><?php mcf_the_field('question_template_main_lvl_9'); ?></h2>
