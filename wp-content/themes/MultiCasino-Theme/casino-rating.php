			...
			<?php while (mcf_have_rows('add_block_template_casinorating')): mcf_the_row(); ?>
				...
				<?php if (mcf_get_row_layout() === 'Main_Block_template_casinorating'): ?>
					<section class="block RGLItQW9aH uaQATjNZJ1 img-2">
						<section class="uxcpYpQeX">
							...
							<p><?php mcf_the_field('text_template_casinorating_lvl_1'); ?></p>
						</section>
						<?php $img = mcf_get_image_field('img_template_casinorating_lvl_1'); ?>
						<?php if ($img) : ?>
				...
				<?php elseif (mcf_get_row_layout() === 'Recommended_online_casinos_template_casinorating'): ?>
					<section class="block HgNEXbcXKiOWGk0V" id="casinos-block-2">
						<h2 class="ttOKnNStIgHIN pGogQv3MnXHv"><?php mcf_the_field('Title_rec_online_casinos_template_casinorating_lvl_2'); ?></h2>

						<section class="best-casinos-items" id="bestCasinosItems"></section>

						<section class="rEHnqyaLPAcb">
							<a href="#" id="casinos-block-2-read-more" class="UUoOFZTKQLWyzx">
								<?php mcf_the_field('Nazvanie_knopki_podgruzki_dllya_kazino'); ?>
							</a>
						</section>

						<script>
							var casinosTagIds = <?php echo json_encode(get_taxonomy_field('Po_kakomu_tegu_vyvodit_kazino')); ?>;
						</script>
					</section>
				...
				<?php elseif (mcf_get_row_layout() === 'Block_Slots_template_casinorating'): ?>
					<section class="block DOWlz7LHfQhP" id="slots-block-2">
						<h2 class="ttOKnNStIgHIN pGogQv3MnXHv"><?php mcf_the_field('Title_Slots_template_casinorating_lvl_4'); ?></h2>

						<section class="slots-items"></section>

						<section class="rEHnqyaLPAcb">
							<a href="#" id="slots-block-2-read-more" class="UUoOFZTKQLWyzx">
								<?php mcf_the_field('Nazvanie_knopki_podgruzki_dllya_slotov'); ?>
							</a>
						</section>

						<script>
							var slotsTagIdsBlock2 = <?php echo json_encode(get_taxonomy_field('Po_kakomu_tegu_vyvodit_kazino_0')); ?>;
						</script>
					</section>
							...
							<?php if (mcf_have_rows('add_Faq_template_casinorating_lvl_7')): ?>
								<?php while (mcf_have_rows('add_Faq_template_casinorating_lvl_7')): mcf_the_row(); ?>
									<section class="faq-item">
										<section class="faq-item-title"><?php mcf_the_field('question_template_casinorating_lvl_7'); ?></section>
