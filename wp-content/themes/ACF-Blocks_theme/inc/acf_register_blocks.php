...
if (function_exists('acf_register_block_type')) {
  ...
  // Регистрация блоков
    ...
    acf_register_block_type(array(
        'name'              => 'gutenberg-container',
        'title'             => __('Контейнер для Gutenberg блоков', 'your-theme-text-domain'),
        'description'       => __('ACF блок с возможностью добавления любых Gutenberg блоков', 'your-theme-text-domain'),
        'render_template'   => 'template-parts/blocks/main-blocks/gutenberg-container.php',
        'category'          => 'layout',
        'icon'              => 'admin-generic',
        'keywords'          => array('container', 'gutenberg', 'блоки', 'контейнер'),
        'supports'          => array(
            'align' => array('wide', 'full'),
            'jsx' => true, // Обязательно для InnerBlocks
            'anchor' => true,
        ),
        'mode'              => 'edit' // Режим редактирования по умолчанию
    ));

    // Advanced Gutenberg Container Block
    acf_register_block_type(array(
        'name'              => 'gutenberg-container-advanced',
        'title'             => __('Расширенный контейнер Gutenberg', 'your-theme-text-domain'),
        'description'       => __('Продвинутый ACF блок с дополнительными настройками для Gutenberg блоков', 'your-theme-text-domain'),
        'render_template'   => 'template-parts/blocks/main-blocks/gutenberg-container-advanced.php',
        'category'          => 'layout',
        'icon'              => 'admin-page',
        'keywords'          => array('container', 'gutenberg', 'advanced', 'расширенный', 'блоки'),
        'supports'          => array(
            'align' => array('wide', 'full'),
            'jsx' => true,
            'anchor' => true,
    ...
    // Универсальные версии блоков для контейнеров (без ограничения parent)
    acf_register_block_type(array(
        'name'              => 'promo-block-universal',
        'title'             => __('Промо блок (универсальный)', 'your-theme-text-domain'),
        'description'       => __('Промо блок для использования в любом контейнере', 'your-theme-text-domain'),
        'render_template'   => 'template-parts/blocks/main-blocks/promo_block.php',
        'category'          => 'custom-blocks',
        'icon'              => 'megaphone',
        'keywords'          => array('promo', 'промо', 'реклама'),
    ));

    acf_register_block_type(array(
        'name'              => 'nav-block-universal',
        'title'             => __('Навигационный блок (универсальный)', 'your-theme-text-domain'),
        'description'       => __('Навигационный блок для использования в любом контейнере', 'your-theme-text-domain'),
        'render_template'   => 'template-parts/blocks/main-blocks/nav_block.php',
        'category'          => 'custom-blocks',
        'icon'              => 'menu-alt',
        'keywords'          => array('navigation', 'навигация', 'меню'),
    ));

    acf_register_block_type(array(
        'name'              => 'game-block-universal',
        'title'             => __('Блок игр (универсальный)', 'your-theme-text-domain'),
        'description'       => __('Блок игр для использования в любом контейнере', 'your-theme-text-domain'),
        'render_template'   => 'template-parts/blocks/main-blocks/game_block.php',
        'category'          => 'custom-blocks',
        'icon'              => 'games',
        'keywords'          => array('games', 'игры', 'развлечения'),
    ));

    acf_register_block_type(array(
        'name'              => 'advice-block-universal',
        'title'             => __('Блок советов (универсальный)', 'your-theme-text-domain'),
        'description'       => __('Блок советов для использования в любом контейнере', 'your-theme-text-domain'),
        'render_template'   => 'template-parts/blocks/main-blocks/advice_block.php',
        'category'          => 'custom-blocks',
        'icon'              => 'lightbulb',
        'keywords'          => array('advice', 'советы', 'рекомендации'),
    ));

    acf_register_block_type(array(
        'name'              => 'faq-block-universal',
        'title'             => __('FAQ блок (универсальный)', 'your-theme-text-domain'),
        'description'       => __('FAQ блок для использования в любом контейнере', 'your-theme-text-domain'),
        'render_template'   => 'template-parts/blocks/main-blocks/faq_block.php',
        'category'          => 'custom-blocks',
        'icon'              => 'editor-help',
        'keywords'          => array('faq', 'questions', 'вопросы', 'ответы'),
    ));
