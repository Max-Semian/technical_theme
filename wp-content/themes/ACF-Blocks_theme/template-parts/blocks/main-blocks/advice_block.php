<!-- template-parts/blocks/elements-block/advice_block.php -->
<?php
...
if ($visibility) { ?>
 <section id="<?php if($block_id){ echo $block_id;}?>" class="advice-block" style="background-color: <?php if($color_theme){ echo $color_theme;}else{ echo '#fff';}?>"> 
 <?php if($color_container){ echo 'style="background: '.$color_container.'"';}?> 
