<!-- template-parts/blocks/elements-block/simple-text-block.php -->
<?php
...
if ($visibility) { ?>
 <section id="<?php if($block_id){ echo $block_id;}?>" class="text-block" style="background-color: <?php if($color_theme){ echo $color_theme;}else{ echo '#fff';}?>">
  <div class="container simple-block" <?php if($color_container){ echo ' style="background: '.$color_container.'"';}?>>
