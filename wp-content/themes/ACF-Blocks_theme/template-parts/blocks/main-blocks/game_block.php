<!-- template-parts/blocks/elements-block/game_block.php -->
<?php
...
if ($visibility) { ?>
 <section id="<?php if($block_id){ echo $block_id;}?>" class="game-block" style="background-color: <?php if($color_theme){ echo $color_theme;}else{ echo '#fff';}?>">
