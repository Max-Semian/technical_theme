<!-- template-parts/blocks/elements-block/faq_block.php -->
<?php
...
if ($visibility) { ?>
 <section id="<?php if($block_id){ echo $block_id;}?>" class="faq-block" style="background-color: <?php if($color_theme){ echo $color_theme;}else{ echo '#fff';}?>">
